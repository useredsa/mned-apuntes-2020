...
Llegamos a que
$$
error_{n+1} \leq (1+hk)^{n+1}error_0 + \overset{\textnormal{serie geométrica entre 0 y n}}{\overbrace{\left[ 1 + (1+hk) + (1+hk)^2 + \cdots + (1+hk)^{n}\right]}}\frac{1}{2}h^2c =  
$$
$$
= (1+hk)^{n+1}error_0 + \left[\frac{(1+hk)^{n+1} - 1}{hk}\right]\frac{1}{2}h^2c = (1+hk)^{n+1}error_0 + \left[\frac{(1+hk)^{n+1} - 1}{k}\right]\frac{1}{2}hc \overset{\ref{lema2}}{\leq} 
$$
$$
\leq e^{hk(n+1)}error_0 + \left[\frac{e^{hk(n+1)} - 1}{k}\right]\frac{1}{2}hc =  e^{(b-a)k}\|Y(t_0) - y_h(t_0)\| + \left[\frac{e^{(b-a)k} - 1}{k}\right]\frac{1}{2}hc \qedhere
$$
\end{proof}
